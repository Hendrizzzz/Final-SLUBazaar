...
<head>
    ...
    <title>Edit Listing - SLU Bazaar</title>
        ...
        <main class="content-wrapper">
            ...
            <div class="content">
                ...
                <div class="listing-container">
                    <form action="/items/update" method="POST" enctype="multipart/form-data" class="listing-form">
                        ...
                        <div class="form-body">
                            <div class="form-left">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="description" name="description" rows="6" required><?= htmlspecialchars($item['description']) ?></textarea>
                                </div>
                                <div class="form-row">
                                    <div class="form-group">
                                        <label for="starting_bid">Starting Amount:</label>
                                        <input type="number" id="starting_bid" name="starting_bid" step="0.01" min="0" value="<?= $item['starting_bid'] ?>" required>
                                    </div>
                                    <div class="form-group">
